  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div className="grid md:grid-cols-2 gap-8 mb-12">
      ...
      <div className="space-y-6">
        ...
        {/* Embedded Google Map */}
        <div className="mt-6 w-full h-64 md:h-80 rounded-lg overflow-hidden">
          {project.id === 'serenity-nest' && (
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3804.451067080757!2d78.47849577501974!3d17.533698398573964!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bcb850067b25ea5%3A0x5c0bec359e9815fa!2sSerenity%20Nest!5e0!3m2!1sen!2sin!4v1758779753409!5m2!1sen!2sin"
              width="100%"
              height="100%"
              style={{ border: 0 }}
              allowFullScreen
